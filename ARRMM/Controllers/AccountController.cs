...
namespace ARRMM.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterUserViewModel model, string returnUrl = null)
        {
            ...
            {
                var result = await _securityService.CreateUser(model.FirstName, model.LastName, model.UserName, model.Email, model.NicNumber, model.Password, model.ConfirmPassword, false);
                if (result.Success)
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            {
                var logoutResult = await _securityService.Logout();
                if (!logoutResult.Success)
                    return View("Error");

                await HttpContext.SignOutAsync(CookieAuthenticationDefaults.AuthenticationScheme);
            }
            var result = await _securityService.ConfirmEmail(userId, code);
        ...
        {
            ViewData["ReturnUrl"] = returnUrl;
            //var result = await HttpClientHelper.GetAsync<List<ExternalAuthenticationProvider>>("Account/GetLoginProviders");
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            var tokenResponse = await _securityService.Login(model.UserName, model.Password);
            if (tokenResponse.Success)
            {
                //var claims = JsonSerializer.Deserialize<List<Claim>>(tokenResponse.Data);
                var userResponse = await IdentityLogin(tokenResponse.Data, model.RememberMe);
        ...
        //    var tokenResponse = await HttpClientHelper.TokenAsync("Account/TwoFactorLogin", model);
        ...
        //    var tokenResponse = await HttpClientHelper.TokenAsync("Account/RecoveryCodeLogin", model);
        //    if (tokenResponse.Status == LoginStatus.Succeded)
        //    {
        //        var accessToken = tokenResponse.Data.ToString();
        //        await HttpClientHelper.SetBearerToken(accessToken);
        ...
        //    var loginProperties = await HttpClientHelper.GetAsync<AuthenticationProperties>("Account/GetLoginProperties?provider=" + provider + "&redirectUrl=" + redirectUrl);
        ...
        //    var tokenResponse = await HttpClientHelper.TokenAsync("Account/ExternalLogin", model);
        //    if (tokenResponse.Status == LoginStatus.Succeded)
        //    {
        //        var accessToken = tokenResponse.Data.ToString();
        //        await HttpClientHelper.SetBearerToken(accessToken);
        ...
        //    var tokenResponse = await HttpClientHelper.TokenAsync("Account/RegisterExternal", model);
        //    if (tokenResponse.Status == LoginStatus.Succeded)
        //    {
        //        var accessToken = tokenResponse.Data.ToString();
        //        await HttpClientHelper.SetBearerToken(accessToken);
        ...
        private async Task<Tuple<bool, string>> IdentityLogin(ClaimsPrincipal claimPrincipal, bool rememberBrowser = false, bool rememberMachine = false)
        {
        ...
        //{
        //    var userResponse = await HttpClientHelper.GetAsync<UserClaim>("Account/GetUser");
        ...
        //{
        //    var userResponse = await HttpClientHelper.GetAsync<UserClaim>("Account/GetExternalUser?loginProvider=" + loginProvider + "&providerKey=" + providerKey);
        //    if (userResponse.Success)
        //    {
        //        var claim = userResponse.Data;
        ...
        public async Task<IActionResult> UserProfile(string message = null)
        {
            ...
            var response = await _securityService.GetUserDetail(User.GetUserId());
            if (response.Success)
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var result = await _securityService.ChangePassword(User.GetUserName(), model.OldPassword, model.NewPassword);
            if (result.Success)
        ...
        //    var result = await HttpClientHelper.PostAsync<SetPasswordViewModel>("Account/SetPassword", model);
        //    if (result.Success)
        ...
        public async Task<IActionResult> ChangeEmail(ChangeEmailViewModel model)
        {
            ...
            var result = await _securityService.GenerateChangeEmailToken(User.GetUserId(), model.Email);
            if (result.Success)
                return RedirectToAction(nameof(UserProfile), new { message = result.Message });
        ...
        public async Task<IActionResult> ChangeEmail(string userId, string email, string code)
        {
            ...
            var result = await _securityService.ChangeEmail(User.GetUserId(), model.Email, model.Code);
            return result.Success
        ...
        public async Task<IActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            var result = await _securityService.GenerateChangePhoneNumberToken(User.GetUserId(), model.PhoneNumber);
            if (result.Success)
        ...
        public async Task<IActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            var result = await _securityService.ChangePhoneNumber(User.GetUserId(), model.PhoneNumber, model.Code);
            if (result.Success)
        ...
        {
            var result = await _securityService.RemovePhoneNumber(User.GetUserId());
            if (result.Success)
        ...
        //    var authenticationResponse = await HttpClientHelper.GetAsync<UserAuthenticationInfo>("Account/GetAuthenticationDetail");
        ...
        //{
        //    var response = await HttpClientHelper.GetAsync<AuthenticatorViewModel>("Account/GetSharedKeyAndQrCodeUri");
        //    if (!response.Success)
        ...
        //    {
        //        Provider = TwoFactorTypes.Authenticator,
        //        Code = model.Code
        //    };
        //    var authenticatorResult = await HttpClientHelper.PostAsync<IEnumerable<string>>("Account/EnableTwoFactorAuthentication", verifyCodeModel);
        ...
        //{
        //    var resetAuthenticatorResult = await HttpClientHelper.GetAsync<string>("Account/ResetAuthenticator");
        ...
        //    {
        //        SelectedProvider = TwoFactorTypes.Email
        //    };
        ...
        //    var otpResult = await HttpClientHelper.PostAsync<IEnumerable<string>>("Account/EnableTwoFactorAuthentication", model);
        //    if (!otpResult.Success)
        //    {
        //        ModelState.AddModelError("Code", otpResult.Message);
        //        return View(model);
        ...
        //{
        //    var disable2faResult = await HttpClientHelper.GetAsync<string>("Account/DisableTwoFactorAuthentication");
        ...
        //{
        //    var recoveryCodesResult = await HttpClientHelper.GetAsync<IEnumerable<string>>("Account/GenerateTwoFactorRecoveryCodes");
        ...
        //    var loginProperties = await HttpClientHelper.GetAsync<AuthenticationProperties>("Account/GetLoginProperties?provider=" + provider + "&redirectUrl=" + redirectUrl + "&userId=" + userId);
        //    if (loginProperties.Success)
        //        return new ChallengeResult(provider, loginProperties.Data);
        //    else
        ...
        //    var result = await HttpClientHelper.PostAsync<string>("Account/AddLogin", model);
        ...
        //{
        //    var result = await HttpClientHelper.PostAsync<string>("Account/RemoveLogin", new RemoveLoginViewModel { Provider = provider, ProviderKey = providerKey });
        //    return RedirectToAction(nameof(ManageLogins), new { message = result.Message });
        //}
